...
const apiKey = "4qnvchf3fgm3" || process.env.REACT_APP_STREAM_KEY;
const user = "longjueyue" || process.env.REACT_APP_USER_ID;
const userToken =
...
export const targetOrigin =
  "https://getstream.io" || process.env.REACT_APP_TARGET_ORIGIN;
